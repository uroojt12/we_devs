      ...
      <footer id={style.footer}>
        <div className={style.contain}>
              ...
              <div className={style.column}>
                ...
                <ul className={style.list}>
                  <li>
                    <strong>A.</strong>{" "}
                    <span>
                      Mawk tech space ,2nd floor,ahsan cash & carry near Burj
                      Huraira, <br />
                      Zafrullah Chowk
                    </span>
                  </li>
                  <li>
                    <strong>P.</strong>{" "}
                    <a href="tel:+92 309 0215441">+92 309 0215441</a>
                  </li>
                  <li>
                    <strong>E.</strong>{" "}
                    <a href="mailto:sales@wedevs.co">sales@wedevs.co</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={style.copyright}>
            <p>
              © 2024 <Link href="/">Wedevs + &lt;/&gt;.</Link> All rights
              reserved.
            </p>
          </div>
        </div>
