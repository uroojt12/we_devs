...
import {
  ...
  IconCreative,
  IconLayers,
  PhotoBrandBlk_google,
  PhotoBrandCoinbase,
  PhotoBrandGrandHyatt,
  PhotoBrandJohnDeere,
  PhotoBrandVisa,
  PhotoBrandZoom,
      ...
      <section id={style.serve}>
        <div className={style.contain}>
          <div className={style.content}>
            ...
            <p>
              At Wedevs, we are dedicated to transforming your digital vision
              into reality. As a leading provider of comprehensive web services
              and development solutions, we specialize in web design,
              development, hosting, and more. Our team of skilled professionals
              is committed to delivering cutting-edge solutions tailored to meet
          ...
          <div className={style.wrapper}>
            ...
            <div className={style.column}>
              <div className={style.serve_blk}>
                ...
                <p>
                  Take your business to the next level with our e-commerce
                  solutions. We design and develop secure and user-friendly
                  online stores tailored to your products and target audience.
                </p>
              </div>
            </div>
            <div className={style.column}>
              <div className={style.serve_blk}>
                ...
                <p>
                  Ensure the performance and security of your website with our
                  reliable hosting and maintenance services. Focus on your
            ...
            <div className={style.column}>
              <div className={style.serve_blk}>
                ...
                <h2>SEO Identity</h2>
                <p>
                  Equip your brand with content that will break through the
                  digital noise and a personalised social media strategy to
                  increase customer retention rates by 77%.
                </p>
              </div>
            </div>
          </div>
